...
public class MathUtils {
    ...
    //Returns parameter a to the power of b
    public static float power(float a,int b){
        return (float) Math.pow(a, b);
    }
    
    //Returns the float value from the square root of a squared and b squared 
    public static float Pythagore2D(float a,float b){
        return (float) Math.sqrt(a*a+b*b);
    }
    
    //Returns the float value from the square root of a squared, b squared and c squared
    public static float Pythagore3D(float a,float b,float c){
        return (float) Math.sqrt(a*a+b*b+c*c);
    }
    
    //Returns a float value of the conversion into radians.
    public static float Deg2Rad(float deg){
        return (deg*PI)/180;
    }
    
    //Returns a float value of the conversion into degrees.
    public static float Rag2Deg(float rag){
        return (rag*180)/PI;
    }

    //Returns the float value of the length of the opposite side providing a for angle  and b for hypotenuse. 
    public static float OppositeSide(float a,float b){
        return b * (float)Math.sin(a);
    }
    
    //Returns the float value of the angle providing a for opposite and b for hypotenuse. 
    public static float SinAngle(float a,float b){
        return (float)Math.asin(a/b);
    }
    
    //Returns the float value of the length of the adjacent side providing a for angle  and b for hypotenuse. 
    public static float AdjacentSide(float a,float b){
        return b * (float)Math.cos(a);    
    }
    
    //Returns the float value of the angle providing a for adjacent and b for hypotenuse. 
    public static float CosAngle(float a,float b){
        return (float)Math.acos(a/b);
    }
    
    //Returns the float value of the angle providing a for opposite and b for adjacent. 
